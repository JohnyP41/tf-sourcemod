...
public void OnPluginStart()
{
	...
	CreateConVar("onlineshop_url", "polskieognisko.ovh/sklep/", "Online Shop WEB URL");
...
{	
	if(PlayerBuy[User])
	{
		...
		Format(URL, sizeof(URL), "https://%s/index.php?pages=server_buy&sid=%s&premium=%s&serverid=%i", ShopURL, SID, PremiumID, ServerID);
